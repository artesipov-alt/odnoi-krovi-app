...
const file_api_greet_v1_greet_proto_rawDesc = "" +
	...
	"\fGreetService\x128\n" +
	"\x05Greet\x12\x16.greet.v1.GreetRequest\x1a\x17.greet.v1.GreetResponseB\xaa\x01\n" +
	"\fcom.greet.v1B\n" +
	"GreetProtoP\x01ZMgithub.com/artesipov-alt/odnoi-krovi-app/poolservice/gen/api/greet/v1;greetv1\xa2\x02\x03GXX\xaa\x02\bGreet.V1\xca\x02\bGreet\\V1\xe2\x02\x14Greet\\V1\\GPBMetadata\xea\x02\tGreet::V1b\x06proto3"
