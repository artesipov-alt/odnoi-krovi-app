...
var (
	...
	PetsColumns = []*schema.Column{
		...
		{Name: "donor_stop_factors", Type: field.TypeJSON, Nullable: true},
		{Name: "donor_warn_factors", Type: field.TypeJSON, Nullable: true},
	...
	PetsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{PetsColumns[21]},
