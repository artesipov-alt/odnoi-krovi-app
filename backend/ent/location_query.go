...
func (_q *LocationQuery) QueryUsers() *UserQuery {
...
func (_q *LocationQuery) WithUsers(opts ...func(*UserQuery)) *LocationQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *LocationQuery) loadUsers(ctx context.Context, query *UserQuery, nodes []*Location, init func(*Location), assign func(*Location, *User)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(user.FieldLocationID)
	}
