...
func (_q *BreedQuery) Where(ps ...predicate.Breed) *BreedQuery {
	_q.predicates = append(_q.predicates, ps...)
	return _q
}

// Limit the number of records to be returned by this query.
func (_q *BreedQuery) Limit(limit int) *BreedQuery {
	_q.ctx.Limit = &limit
	return _q
}

// Offset to start from.
func (_q *BreedQuery) Offset(offset int) *BreedQuery {
...
func (_q *BreedQuery) Unique(unique bool) *BreedQuery {
	_q.ctx.Unique = &unique
	return _q
}

// Order specifies how the records should be ordered.
func (_q *BreedQuery) Order(o ...breed.OrderOption) *BreedQuery {
	_q.order = append(_q.order, o...)
	return _q
}

// QueryPets chains the current query on the "pets" edge.
func (_q *BreedQuery) QueryPets() *PetQuery {
...
func (_q *BreedQuery) First(ctx context.Context) (*Breed, error) {
...
func (_q *BreedQuery) FirstX(ctx context.Context) *Breed {
...
func (_q *BreedQuery) Only(ctx context.Context) (*Breed, error) {
...
func (_q *BreedQuery) OnlyX(ctx context.Context) *Breed {
...
func (_q *BreedQuery) All(ctx context.Context) ([]*Breed, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryAll)
	if err := _q.prepareQuery(ctx); err != nil {
		return nil, err
	}
	qr := querierAll[[]*Breed, *BreedQuery]()
	return withInterceptors[[]*Breed](ctx, _q, qr, _q.inters)
}

// AllX is like All, but panics if an error occurs.
func (_q *BreedQuery) AllX(ctx context.Context) []*Breed {
...
func (_q *BreedQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if err = _q.Select(breed.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *BreedQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryCount)
	if err := _q.prepareQuery(ctx); err != nil {
		return 0, err
	}
	return withInterceptors[int](ctx, _q, querierCount[*BreedQuery](), _q.inters)
}

// CountX is like Count, but panics if an error occurs.
func (_q *BreedQuery) CountX(ctx context.Context) int {
...
func (_q *BreedQuery) Exist(ctx context.Context) (bool, error) {
...
func (_q *BreedQuery) ExistX(ctx context.Context) bool {
...
func (_q *BreedQuery) Clone() *BreedQuery {
	if _q == nil {
		return nil
	}
	return &BreedQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]breed.OrderOption{}, _q.order...),
		inters:     append([]Interceptor{}, _q.inters...),
		predicates: append([]predicate.Breed{}, _q.predicates...),
...
func (_q *BreedQuery) WithPets(opts ...func(*PetQuery)) *BreedQuery {
	query := (&PetClient{config: _q.config}).Query()
...
func (_q *BreedQuery) Select(fields ...string) *BreedSelect {
	...
	sbuild := &BreedSelect{BreedQuery: _q}
...
func (_q *BreedQuery) Aggregate(fns ...AggregateFunc) *BreedSelect {
	return _q.Select().Aggregate(fns...)
}

func (_q *BreedQuery) prepareQuery(ctx context.Context) error {
...
func (_q *BreedQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Breed, error) {
	var (
		nodes       = []*Breed{}
		_spec       = _q.querySpec()
		loadedTypes = [1]bool{
	...
	_spec.Assign = func(columns []string, values []any) error {
		node := &Breed{config: _q.config}
		nodes = append(nodes, node)
		node.Edges.loadedTypes = loadedTypes
		return node.assignValues(columns, values)
	}
	_spec.Node.Schema = _q.schemaConfig.Breed
...
func (_q *BreedQuery) loadPets(ctx context.Context, query *PetQuery, nodes []*Breed, init func(*Breed), assign func(*Breed, *Pet)) error {
	...
	query.Where(predicate.Pet(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(breed.PetsColumn), fks...))
	}))
...
func (_q *BreedQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1.Schema(_q.schemaConfig.Breed)
	ctx = internal.NewSchemaConfigContext(ctx, _q.schemaConfig)
...
func (_g *BreedGroupBy) Aggregate(fns ...AggregateFunc) *BreedGroupBy {
	_g.fns = append(_g.fns, fns...)
	return _g
}

// Scan applies the selector query and scans the result into the given value.
func (_g *BreedGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _g.build.ctx, ent.OpQueryGroupBy)
	if err := _g.build.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*BreedQuery, *BreedGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *BreedGroupBy) sqlScan(ctx context.Context, root *BreedQuery, v any) error {
...
func (_s *BreedSelect) Aggregate(fns ...AggregateFunc) *BreedSelect {
	_s.fns = append(_s.fns, fns...)
	return _s
}

// Scan applies the selector query and scans the result into the given value.
func (_s *BreedSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _s.ctx, ent.OpQuerySelect)
	if err := _s.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*BreedQuery, *BreedSelect](ctx, _s.BreedQuery, _s, _s.inters, v)
}

func (_s *BreedSelect) sqlScan(ctx context.Context, root *BreedQuery, v any) error {
