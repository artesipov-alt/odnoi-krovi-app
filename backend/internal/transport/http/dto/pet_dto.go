...
type CreatePetBody struct {
	...
	BloodGroup         string            `json:"bloodGroup,omitempty" doc:"Группа крови" enum:"DEA 1+,DEA 1-,A,B,AB,UNKNOWN" example:"DEA 1+"`
...
type PetDetail struct {
	...
	OwnerID              string             `json:"ownerId,omitempty" doc:"ID владельца питомца" example:"USR-aBcDeF1234" readOnly:"true"`
	...
	RecoveryDays         *int               `json:"recoveryDays,omitempty" doc:"Дни восстановления после донации" example:"14"`
