...
type ApplicationShort struct {
	...
	DonorPetID       string         `json:"donorPetID" doc:"ID питомца донора" example:"PET-aBcDeF1234"`
	...
	Bonuses          []common.Bonus `json:"bonuses" doc:"Бонусы портала"`
...
type CompletedDonationsList struct {
	...
	Total                   int                    `json:"total" doc:"Общее количество донаций"`
	TotalDonatedVolume      float64                `json:"totalDonatedVolume" doc:"Общий объем сданной крови в мл"`
