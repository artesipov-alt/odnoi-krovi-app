...
func withBloodComponentID(id string) bloodcomponentOption {
...
func (m *BloodComponentMutation) SetID(id string) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *BloodComponentMutation) ID() (id string, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *BloodComponentMutation) IDs(ctx context.Context) ([]string, error) {
	switch {
