...
// 	Search(ctx context.Context, filters repositories.BloodStockFilters) ([]alpha.BloodStock, error)

// 	// CreateBloodStock создает новый запас крови
// 	CreateBloodStock(ctx context.Context, stockData BloodStockCreate) (*alpha.BloodStock, error)
...
// 	bloodStockRepo repositories.BloodStockRepository,
// 	bloodTypeRepo repositories.BloodInfoRepository,
// 	vetClinicRepo repositories.VetClinicRepository,
...
// // GetAll получает все запасы крови
// func (s *BloodStockServiceImpl) GetAll(ctx context.Context) ([]alpha.BloodStock, error) {
...
// // GetByID получает запас крови по ID
// func (s *BloodStockServiceImpl) GetByID(ctx context.Context, id int) (*alpha.BloodStock, error) {
...
// // GetByClinicID получает все запасы крови для клиники
// func (s *BloodStockServiceImpl) GetByClinicID(ctx context.Context, clinicID int) ([]alpha.BloodStock, error) {
...
// // GetByBloodTypeID получает все запасы крови по типу крови
// func (s *BloodStockServiceImpl) GetByBloodTypeID(ctx context.Context, bloodTypeID int) ([]alpha.BloodStock, error) {
...
// // CreateBloodStock создает новый запас крови
// func (s *BloodStockServiceImpl) CreateBloodStock(ctx context.Context, stockData BloodStockCreate) (*alpha.BloodStock, error) {
// 	// Проверяем существование типа крови
...
// // Search выполняет поиск запасов крови по фильтрам
// func (s *BloodStockServiceImpl) Search(ctx context.Context, filters repositories.BloodStockFilters) ([]alpha.BloodStock, error) {
