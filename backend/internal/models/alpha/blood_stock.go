...
type BloodStock struct {
	...
	PetType        models.PetType          `gorm:"type:varchar(50)" json:"petType" example:"dog"`
	...
	Status         models.BloodStockStatus `gorm:"type:varchar(50);default:'active'" json:"status,omitempty" example:"active"`
