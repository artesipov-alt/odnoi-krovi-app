...
import type {
  AppError,
  DonorRestrictionResponse,
  ReferenceData,
} from '../models/index';
import {
    AppErrorFromJSON,
    AppErrorToJSON,
    DonorRestrictionResponseFromJSON,
    DonorRestrictionResponseToJSON,
...
export class ReferenceV1Api extends runtime.BaseAPI {
     ...
     */
    async getDonorRestrictionsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DonorRestrictionResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => DonorRestrictionResponseFromJSON(jsonValue));
    }
     ...
     * Получение всех ограничений для доноров
     */
    async getDonorRestrictions(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DonorRestrictionResponse> {
