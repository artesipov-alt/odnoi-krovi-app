...
import {
    ...
    PetCreateFromJSON,
    PetCreateToJSON,
    PetCreateResponseFromJSON,
    PetCreateResponseToJSON,
    PetUpdateFromJSON,
    PetUpdateToJSON,
...
export class PetsV1Api extends runtime.BaseAPI {
     ...
     */
    async createPetRaw(requestParameters: CreatePetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PetCreateResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PetCreateResponseFromJSON(jsonValue));
    }
     ...
     * Создание нового питомца
     */
    async createPet(requestParameters: CreatePetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PetCreateResponse> {
