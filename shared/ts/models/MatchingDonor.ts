...
export interface MatchingDonor {
     ...
     * @memberof MatchingDonor
     */
    petType: MatchingDonorPetTypeEnum;
    /**
 ...
 * @export
 */
export const MatchingDonorPetTypeEnum = {
    Dog: 'dog',
    Cat: 'cat'
} as const;
export type MatchingDonorPetTypeEnum = typeof MatchingDonorPetTypeEnum[keyof typeof MatchingDonorPetTypeEnum];
