...
export function PetDetailToJSONTyped(value?: Omit<PetDetail, '$schema'|'createdAt'|'deletedAt'|'id'|'ownerName'|'updatedAt'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
