...
func (r *RedisPetRepository) AddPet(ctx context.Context, pet *bloodrequestv1.BloodRequest, ttl time.Duration) error {
...
func (r *RedisPetRepository) GetPetByID(ctx context.Context, petID string) (*bloodrequestv1.BloodRequest, error) {
	...
	var pet bloodrequestv1.BloodRequest
...
func (r *RedisPetRepository) GetPetsByCriteria(ctx context.Context, criteria *bloodrequestv1.GetBloodRequests) ([]*bloodrequestv1.BloodRequest, error) {
	...
	var pets []*bloodrequestv1.BloodRequest
...
func (r *RedisPetRepository) GetPetsByRegion(ctx context.Context, region int32) ([]*bloodrequestv1.BloodRequest, error) {
	regionKey := fmt.Sprintf("%s%d", IndexRegionPrefix, region)
...
func (r *RedisPetRepository) GetPetsByBloodGroup(ctx context.Context, bloodGroup string) ([]*bloodrequestv1.BloodRequest, error) {
...
func (r *RedisPetRepository) GetAllPets(ctx context.Context, limit, offset int64) ([]*bloodrequestv1.BloodRequest, error) {
	...
	if start > int64(len(allKeys)) {
		return []*bloodrequestv1.BloodRequest{}, nil
	}
...
func (r *RedisPetRepository) GetActivePetsFromPool(ctx context.Context) ([]*bloodrequestv1.BloodRequest, error) {
	now := time.Now().Unix()
...
func (r *RedisPetRepository) updateIndexesWithTTL(ctx context.Context, pipe redis.Pipeliner, pet *bloodrequestv1.BloodRequest, ttl time.Duration) error {
	key := PetKeyPrefix + pet.PetId
	...
	for _, bg := range pet.BloodGroup {
		bloodKey := IndexBloodGroupPrefix + bg
...
func (r *RedisPetRepository) removeFromIndexes(ctx context.Context, pipe redis.Pipeliner, pet *bloodrequestv1.BloodRequest) error {
	key := PetKeyPrefix + pet.PetId
