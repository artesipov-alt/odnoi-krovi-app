...
// import { checkProfile, registerUser } from 'services/telegram.service';
//
...
//         role: 'pet_owner',
//         full_name: user ? `${user.firstName} ${user.lastName || ''}`.trim() : 'Тест Пользователь',
//         phone: '',
//         email: '',
//         consent_pd: false,
//     });
...
//                 <select name='role' value={formData.role} onChange={handleInputChange} className={styles.input}>
