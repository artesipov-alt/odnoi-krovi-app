...
(function () {
    ...
    WebApp.checkHomeScreenStatus = function (callback) {
        if (!versionAtLeast('8.0')) {
            console.error(
                '[Telegram.WebApp] Method checkHomeScreenStatus is not supported in version ' + webAppVersion,
            );
            throw Error('WebAppMethodUnsupported');
        }
        if (callback) {
    ...
    WebApp.requestEmojiStatusAccess = function (callback) {
        if (!versionAtLeast('8.0')) {
            console.error(
                '[Telegram.WebApp] Method requestEmojiStatusAccess is not supported in version ' + webAppVersion,
            );
            throw Error('WebAppMethodUnsupported');
        }
        if (WebAppEmojiStatusAccessRequested) {
