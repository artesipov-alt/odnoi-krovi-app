                ...
                <div className={aboutStyles.content}>
                    <div className={aboutStyles.historyCard}>
                        ...
                        <div className={aboutStyles.historyLead}>
                            “Идея данного приложения родилась, когда мне пришлось искать кровь для своей кошки Рыси. У
                            Рыси была крупноклеточная лимфома, ей пророчили жить полгода, но мы боролись почти 2.
                        </div>
                        <div className={aboutStyles.historyMain}>
                            <div className={aboutStyles.historyParagraph}>
                                Донорская кровь помогла Рысе прожить еще полгода, среди которых были счастливые моменты
